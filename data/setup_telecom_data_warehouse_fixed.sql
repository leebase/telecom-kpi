-- 🏗️ Telecom Data Warehouse Setup Script (Fixed)
-- Comprehensive star schema for all 5 strategic KPI pillars
-- SQLite compatible implementation - matches existing schema

-- ========================================
-- UPDATE EXISTING TABLES
-- ========================================

-- Add missing columns to existing dim_time table
ALTER TABLE dim_time ADD COLUMN quarter INTEGER;
ALTER TABLE dim_time ADD COLUMN is_month_end INTEGER;
ALTER TABLE dim_time ADD COLUMN is_quarter_end INTEGER;
ALTER TABLE dim_time ADD COLUMN is_year_end INTEGER;

-- Add missing columns to existing dim_region table
ALTER TABLE dim_region ADD COLUMN country TEXT;
ALTER TABLE dim_region ADD COLUMN timezone TEXT;
ALTER TABLE dim_region ADD COLUMN market_type TEXT;
ALTER TABLE dim_region ADD COLUMN population_density TEXT;

-- Add missing columns to existing dim_network_element table
ALTER TABLE dim_network_element ADD COLUMN location TEXT;
ALTER TABLE dim_network_element ADD COLUMN capacity_mbps REAL;
ALTER TABLE dim_network_element ADD COLUMN technology TEXT;
ALTER TABLE dim_network_element ADD COLUMN vendor TEXT;
ALTER TABLE dim_network_element ADD COLUMN installation_date TEXT;
...
-- Update existing dim_time data with new columns
UPDATE dim_time SET 
    quarter = 3,
    is_month_end = 0,
    is_quarter_end = 0,
...
-- Update existing dim_region data with new columns
...
-- Update existing dim_network_element data with new columns
UPDATE dim_network_element SET 
    location = 'North Region',
    capacity_mbps = 1000.0,
    technology = '5G',
    vendor = 'Ericsson',
    installation_date = '2023-01-15'
WHERE network_element_id = 1;
